...
from relations as r 
where r.tags->'admin_level'='10';

alter table admin_level_10 add column geom geometry;

update admin_level_10 as x set geom=(
...
alter table admin_level_10 add column area real;

update admin_level_10 set area=st_area(st_transform(geom,900913))/1000000 ;
